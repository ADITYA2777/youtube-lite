   ...
   <Link to={`/video/${video.videoId}`}>
     <div className="flex ">
       ...
       <div className="flex flex-col ml-2 overflow-hidden">
         ...
         <span
           className="text-[12px] lg:text-[10px] xl:text-[12px] font-semibold mt-2 text-white/[0.7]
                        flex items-center "
         >
           {video?.author?.title}
         ...
         <div
           className="flex text-[12px] lg:text-[10px] xl:text-[12px]  font-semibold text-white/[0.7]
